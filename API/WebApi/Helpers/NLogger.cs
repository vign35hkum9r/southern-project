...
namespace WebApi.Helpers
{
    public class NLogger : ITraceWriter
    {
        ...
        TraceLevel.Error, ClassLogger.Error }, { TraceLevel.Fatal, ClassLogger.Fatal }, { TraceLevel.Warn,ClassLogger.Warn } });
        #endregion
        ...
        /// <param name="level"></param>/// <param name="traceAction"></param>
