...
import { MenuItems } from 'src/app/layout/admin/menuitems/menuitem';
import { SubMenuItems } from 'src/app/layout/admin/menuitems/menuitem';
import { MainMenuItems } from 'src/app/layout/admin/menuitems/menuitem';
...
export class AdminComponent implements OnInit {
  ...
  constructor(private router: Router, private http: HttpClient, private loginservice: LoginService) {
    ...
    this.freamType = 'theme5';
    this.sidebarImg = 'false';
    this.sidebarImgType = 'img1';
    this.layoutType = 'light'; // light(default) dark(dark)

    this.headerTheme = 'theme5'; // theme1(default)
  ...
  /* ngOnInit() {
     ...
     this.http.get(configuration.url + 'User/GetUserMenuByUserId/' + this.userid).subscribe((res: any) => {
       this.menuItems = res;
       this.http.get(configuration.url + 'User/GetUserById/' + this.userid).subscribe((res: any) => {
  ...
  ngOnInit() {
    this.http.get(configuration.url + 'UserMenuMapping/GetMenuMappingByUserId/' + this.userid).subscribe((res: any) => {
      this.menuItems = res;
      ...
      //   localStorage.setItem('UserName', this.username)
      // });
      this.loginservice.User(this.userid).subscribe((res: any) => {
        console.log(res)
        ...
        this.loginservice.setLoggedUserDetails(res);
        this.loggedUser = this.loginservice.getLoggedUserDetails();
